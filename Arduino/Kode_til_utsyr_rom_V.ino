...
char token[] = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI1MTQ0In0.Smq-QRub9DQKJ9nCu3X-dGc2p50HlHGUtzRJXbf_s0s"; //bruker nøkkel i CoT
char keyServo[] = "6385"; // Nøkkel-informasjon om konsollet for styring av Servo hos CoT
char keyMotor[] = "16944";// Nøkkel-informasjon om konsollet for styring av Motor hos CoT
char keyTracking[] = "4783";// Nøkkel-informasjon om konsollet for styring av Lys hos CoT
//char keyNightday[] = "";// Nøkkel-informasjon om konsollet for styring av NattDag hos CoT
char keyDoorbell[] = "7363";// Nøkkel-informasjon om konsollet for styring av ringeklokke hos CoT
char keyTemp[] = "20831";// Nøkkel-informasjon om konsollet for styring av Temperatur hos CoT
