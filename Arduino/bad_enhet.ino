...
char keyTempBathroom[] = "3828";// Nøkkel-informasjon om ønsket Temperatur fra CoT
char keyNightday[] = "4783";// Nøkkel-informasjon om Natt eller Dag fra CoT
char keyLightBathroom[] = "16834"; // Nøkkel-informasjon om tilstanden til lysdioden
...
void loop() {
  ...
  int SignalWantedTemp = circusESP32.read(keyTempBathroom, token);
  ...
  circusESP32.write(keyLightBathroom, signalLight, token); //sender signal til CoT om lys tilstand 
